...
@WebServlet("/myblogmodify.do")
public class MyblogModifyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public MyblogModifyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		MyblogDTO dto = dao.myblogModify(bno);
		
		request.setAttribute("modify", dto);
		
		RequestDispatcher rd = request.getRequestDispatcher("myblog/myblogmodify.jsp");
