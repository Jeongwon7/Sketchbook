...
<%@ include file="../header.jsp" %>
  	...
  	<div class="group">
  		<div class="sub-left">
  			...
  			<form name="guestbook" method="post" enctype="multipart/form-data" action="guestbookmodify.do" onsubmit="return check()" id="isFile">
  				...
  				<table>
  					...
  					<tbody>
  						...
  						<tr>
  							<th scope="col" >内容</th>
  							<td>
  								<textarea name="content" id="summernote" style="width:100%; height:300px;">${dto.content }</textarea>
  							</td>			
  						</tr>
  					  	<tr>
