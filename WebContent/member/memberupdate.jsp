    ...
    <div class="member-contents">
  	<div class="member-group">
  		<div class="member">
  			<h2>会員情報修正</h2>
  			<div class="formtable">
  			<form name="member" method="post" enctype="multipart/form-data" action="memberupdate.do" id="member" onsubmit="return check()">
  				<table >
  					<colgroup>
  						<col width="160px">
  						<col width="auto">
  				...
  				<div class="pagination">
  					...
  					<input type="button" onclick="location.href='javascript:history.go(-2)';" class="btn reset" value="メインへ">
  					<input type="button" class="btn btn-info" id="btn_quit" value="退会" onclick="location.href='memberwithdraw.do'">
				</div>
  				</form>
  			</div>
  		</div>
